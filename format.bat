...
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/discordplugin/discordplugin/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/discordplugin/discordplugin/commands/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/discordplugin/discordplugin/events/*
exit /b 0
